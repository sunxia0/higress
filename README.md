...
- [Final GitHub checks](ci-final.json): CI is not yet green: {'pass': 21, 'skipping': 0, 'fail': 0, 'cancel': 0, 'pending': 2}; see the exact check links and retained attempt diagnostics; [workflow status](ci-final-runs.json).
