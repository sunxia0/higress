...
MCP_ORIGINAL_RUNTIME=${MCP_ORIGINAL_RUNTIME:-$MCP_EVIDENCE_ROOT/candidate-3966c7e6-e/runtime}
MCP_D_WASM=${MCP_D_WASM:-$MCP_EVIDENCE_ROOT/candidate-3966c7e6-d/plugin.wasm}
...
assert subprocess.check_output(['git','-C',str(repo),'rev-parse','HEAD'],text=True).strip()=='3966c7e6c189fa1007fdca0386ad9a8f4291e953'
