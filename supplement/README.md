# Design #4684 verification supplement at unchanged HEAD 3966c7e6
...
The exact candidate remains `3966c7e6c189fa1007fdca0386ad9a8f4291e953`.
...
MCP_REPO=/Users/xiao/.codex/worktrees/8e59/higress-fork \
  bash /Users/xiao/.codex/worktrees/8e59/higress-mcp-auto-tuaqf6zu/supplement/run_session_supplement.sh
```
...
Input paths can be overridden with `MCP_ORIGINAL_RUNTIME` and `MCP_D_WASM`.
...
MCP_HARNESS_DIR=/Users/xiao/.codex/worktrees/8e59/higress-fork/plugins/wasm-go/extensions/mcp-server/testdata/runtime-verification \
  PYTHONDONTWRITEBYTECODE=1 python3 /Users/xiao/.codex/worktrees/8e59/higress-mcp-auto-tuaqf6zu/supplement/verify_session.py --self-test
```
...
PYTHONDONTWRITEBYTECODE=1 python3 \
  /Users/xiao/.codex/worktrees/8e59/higress-mcp-auto-tuaqf6zu/supplement/run_probe_supplement.py \
  --repo /Users/xiao/.codex/worktrees/8e59/higress-fork \
  --out /Users/xiao/.codex/worktrees/8e59/higress-mcp-auto-tuaqf6zu/supplement/probe-oracle-fresh
```
...
The implementation worker already ran this companion successfully in
`probe-oracle/`: original HTTP400/-32020 accepted with exit 0; injected fixture
HTTP500 rejected with exit 42; both host processes exited. Source/overlay and
binary hashes are in `probe-oracle/probe-oracle-summary.json`.
